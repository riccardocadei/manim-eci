...
class S17NEXIS(Slide):
    def construct(self):
        ...
        # ══════════════════════════════════════════════════════════════════════
        # FINAL — Shift graph left + show assumptions pipeline (as in s08)
        # ══════════════════════════════════════════════════════════════════════
        graph_group = VGroup(Z1, Z3, T, Y, a_T_Y, proxy1, proxy3)
        self.play(graph_group.animate.shift(LEFT * 3.0), run_time=0.8)
